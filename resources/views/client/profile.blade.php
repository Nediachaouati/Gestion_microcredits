              ...
              <div>
               ...
               <div class="text-center mb-4">
                <i> <h2 class="section-title px-5" style="color: rgb(49, 48, 48)"><span class="px-2">Modifier Profil </span></h2></i>
                   <hr/></div><br>  
                   <form action="/client/profile/update" method="POST" class="p-5 rounded-lg shadow bg-white" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <label for="">CIN</label>
                                        <input type="text" value="{{ auth()->user()->cin }}" class="form-control" name="cin">
                                    </div><br>
                                    <div class="form-group">
                                        <label for="">Téléphone</label>
                                        <input type="text" value="{{ auth()->user()->telephone }}" class="form-control" name="telephone">
                                    </div><br>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="">Adresse</label>
                                        <input type="text" value="{{ auth()->user()->adresse }}" class="form-control" name="adresse">
                                    </div><br>
                                    <div class="form-group">
                                        <label for="">Date naissance</label>
                                        <input type="date" value="{{ auth()->user()->date_naissance }}" class="form-control" name="date_naissance">
                                    </div><br>
                                    <div class="form-group " >
                                    ...
                                    <div class="form-group">
                                        <label for="">Email de votre employé</label>
                                        @if($employe)
                                            <input type="email" value="{{ $employe->email }}" class="form-control" readonly>
                                        @else
                                            <input type="text" value="Aucun employé assigné" class="form-control" readonly>
                                        @endif
                                    </div><br>
                                </div>
                            </div>
